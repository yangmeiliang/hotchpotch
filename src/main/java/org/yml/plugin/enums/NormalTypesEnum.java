...
public enum NormalTypesEnum {

    VOID("void", "", MockerTypeEnum.String),
    ...
    public static Optional<NormalTypesEnum> of(String shortName) {
        return Arrays.stream(NormalTypesEnum.values()).filter(o -> o.eq(shortName)).findFirst();
    }
}
